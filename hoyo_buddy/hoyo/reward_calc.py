...
class RewardCalculator:
    ...
    def get_rewards(self) -> Tuple[DailyReward, ...]:
        ...
        rewards = {
            TODAY_REWARD: lambda: (
                self._get_reward_name(
                    LAST_REWARD, renamed_monthly_rewards[LAST_REWARD]
                ),
                self._get_reward_name(
                    PREVIOUS_REWARD, renamed_monthly_rewards[PREVIOUS_REWARD]
                ),
                today_reward,
