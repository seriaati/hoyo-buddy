...
YATTA_PROP_TYPE_TO_GPY_TYPE: dict[str, int] = {
    ...
    "baseSpeed": 4,
    "physicalResistanceDelta": 13,
    "fireResistanceDelta": 15,
    "iceResistanceDelta": 17,
    "thunderResistanceDelta": 19,
    "windResistanceDelta": 21,
    "quantumResistanceDelta": 23,
    "imaginaryResistanceDelta": 25,
    "speedDelta": 51,
}
