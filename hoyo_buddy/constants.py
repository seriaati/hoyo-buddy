...
ZZZ_ENKA_STAT_TO_GPY_ZZZ_PROPERTY = {
    ...
    enka.zzz.StatType.DEF_BASE: genshin.models.ZZZPropertyType.BASE_DEF,
    enka.zzz.StatType.ATK_BASE: genshin.models.ZZZPropertyType.BASE_ATK,
    enka.zzz.StatType.HP_BASE: genshin.models.ZZZPropertyType.BASE_HP,
    enka.zzz.StatType.PEN_BASE: genshin.models.ZZZPropertyType.BASE_PEN,
    ...
    enka.zzz.StatType.WIND_DMG_BONUS_FLAT: genshin.models.ZZZPropertyType.DISC_WIND_DMG_BONUS,
}
...
ZZZ_ENKA_AGENT_STAT_TYPE_TO_ZZZ_AGENT_PROPERTY = {
    ...
    enka.zzz.AgentStatType.LACERATION_DMG: genshin.models.ZZZPropertyType.AGENT_LACERATION_DMG,
    enka.zzz.AgentStatType.ASA: genshin.models.ZZZPropertyType.AGENT_ASA,
    ...
    enka.zzz.AgentStatType.WIND_DMG_BONUS: genshin.models.ZZZPropertyType.WIND_DMG_BONUS,
}
