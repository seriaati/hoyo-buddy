...
class Hoyo(commands.Cog):
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("checkin_command_description"),
    )
    @app_commands.rename(
        user=app_commands.locale_str("user_autocomplete_param_name"),
        account=app_commands.locale_str("account_autocomplete_param_name"),
    )
    @app_commands.describe(
        user=app_commands.locale_str("user_autocomplete_param_description"),
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("profile_command_description"),
    )
    @app_commands.rename(
        user=app_commands.locale_str("user_autocomplete_param_name"),
        account=app_commands.locale_str("account_autocomplete_param_name"),
    ...
    @app_commands.describe(
        user=app_commands.locale_str("user_autocomplete_param_description"),
        account=app_commands.locale_str("account_autocomplete_param_description"),
        uid=app_commands.locale_str("profile_command_uid_param_description"),
        game_value=app_commands.locale_str("profile_command_game_value_description"),
    )
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("notes_command_description"),
    )
    @app_commands.rename(
        user=app_commands.locale_str("user_autocomplete_param_name"),
        account=app_commands.locale_str("account_autocomplete_param_name"),
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("characters_command_description"),
    )
    @app_commands.rename(
        user=app_commands.locale_str("user_autocomplete_param_name"),
        account=app_commands.locale_str("account_autocomplete_param_name"),
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("challenge_command_description"),
    )
    @app_commands.rename(
        user=app_commands.locale_str("user_autocomplete_param_name"),
        account=app_commands.locale_str("account_autocomplete_param_name"),
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("exploration_command_description"),
    )
    @app_commands.rename(
        user=app_commands.locale_str("user_autocomplete_param_name"),
        account=app_commands.locale_str("account_autocomplete_param_name"),
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("redeem_command_description"),
    )
    @app_commands.rename(
        user=app_commands.locale_str("user_autocomplete_param_name"),
        account=app_commands.locale_str("account_autocomplete_param_name"),
    ...
    @app_commands.command(
        ...
        description=app_commands.locale_str("geetest_command_description"),
    )
    @app_commands.rename(
        account=app_commands.locale_str("account_autocomplete_param_name"),
        type_=app_commands.locale_str("geetest_command_type_param_name"),
    )
    @app_commands.describe(
        account=app_commands.locale_str("acc_no_default_param_desc"),
        type_=app_commands.locale_str("geetest_cmd_type_param_desc"),
    )
