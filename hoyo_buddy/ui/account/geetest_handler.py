        ...
        if isinstance(self._data, EmailPswdLoginData):
            ...
            if isinstance(result, genshin.models.ActionTicket):
                ...
                if isinstance(email_result, genshin.models.SessionMMT):
                    ...
                    await self._view.prompt_user_to_solve_geetest(self._interaction, for_code=True)
                else:
            ...
            await self._view.prompt_user_to_enter_mobile_otp(self._interaction, self._data.mobile)
